...
Pipeline End-to-End de análisis de ventas: desde la modelización relacional en MySQL hasta un dashboard interactivo en Power BI con KPIs de negocio y medidas DAX.
...
- **Objetivo de operaciones declinadas (<10/mes)**: Incumplido únicamente entre abril y junio de 2021.
